...
```sh
# <2.0
npm install izo-bootstrap-datetimerangepicker onefe-bootstrap-daterangepicker --save

# 2.x
npm install izo-bootstrap-datetimerangepicker bootstrap-daterangepicker --save
```
...
```js
import DatetimeRangePicker from 'izo-bootstrap-datetimerangepicker';
...
[npm]: https://www.npmjs.com/package/izo-bootstrap-datetimerangepicker